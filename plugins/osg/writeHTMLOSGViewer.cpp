    ...
    case SGIItemTypeObject:
        {
            ...
            os << "<tr><td>database pager</td><td>" << getObjectNameAndType(object->getSceneData(), true) << "</td></tr>" << std::endl;
            os << "<tr><td>image pager</td><td>" << getObjectNameAndType(object->getImagePager()) << "</td></tr>" << std::endl;
