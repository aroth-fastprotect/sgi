...
public:
    ...
    void registerGLConstants()
    {
		...
		GLCONSTANT(GL_FRAMEBUFFER_EXT);
		GLCONSTANT(GL_RENDERBUFFER_EXT);
		GLCONSTANT(GL_STENCIL_INDEX1_EXT);
		GLCONSTANT(GL_STENCIL_INDEX4_EXT);
		GLCONSTANT(GL_STENCIL_INDEX8_EXT);
		GLCONSTANT(GL_STENCIL_INDEX16_EXT);
		GLCONSTANT(GL_RENDERBUFFER_WIDTH_EXT);
		GLCONSTANT(GL_RENDERBUFFER_HEIGHT_EXT);
		GLCONSTANT(GL_RENDERBUFFER_INTERNAL_FORMAT_EXT);
		GLCONSTANT(GL_RENDERBUFFER_RED_SIZE_EXT);
		GLCONSTANT(GL_RENDERBUFFER_GREEN_SIZE_EXT);
		GLCONSTANT(GL_RENDERBUFFER_BLUE_SIZE_EXT);
		GLCONSTANT(GL_RENDERBUFFER_ALPHA_SIZE_EXT);
		GLCONSTANT(GL_RENDERBUFFER_DEPTH_SIZE_EXT);
		GLCONSTANT(GL_RENDERBUFFER_STENCIL_SIZE_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT0_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT1_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT2_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT3_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT4_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT5_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT6_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT7_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT8_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT9_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT10_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT11_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT12_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT13_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT14_EXT);
		GLCONSTANT(GL_COLOR_ATTACHMENT15_EXT);
		GLCONSTANT(GL_DEPTH_ATTACHMENT_EXT);
		GLCONSTANT(GL_STENCIL_ATTACHMENT_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_COMPLETE_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_INCOMPLETE_DUPLICATE_ATTACHMENT_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_INCOMPLETE_FORMATS_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_UNSUPPORTED_EXT);
		GLCONSTANT(GL_FRAMEBUFFER_BINDING_EXT);
		GLCONSTANT(GL_RENDERBUFFER_BINDING_EXT);
		GLCONSTANT(GL_MAX_COLOR_ATTACHMENTS_EXT);
		GLCONSTANT(GL_MAX_RENDERBUFFER_SIZE_EXT);
		GLCONSTANT(GL_INVALID_FRAMEBUFFER_OPERATION_EXT);

        GLCONSTANT(GL_TEXTURE_RECTANGLE);
    }
