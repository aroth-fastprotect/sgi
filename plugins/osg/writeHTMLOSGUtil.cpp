    ...
    case SGIItemTypeObject:
        {
            ...
            os << "<tr><td>imageReadPixelFormat</td><td>" << sgi::castToEnumValueString<sgi::GLConstant>(object->getImageReadPixelFormat()) << "</td></tr>" << std::endl;
            os << "<tr><td>imageReadPixelDataType</td><td>" << sgi::castToEnumValueString<sgi::GLConstant>(object->getImageReadPixelDataType()) << "</td></tr>" << std::endl;
