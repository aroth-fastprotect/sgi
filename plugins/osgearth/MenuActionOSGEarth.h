...
ACTION_HANDLER_IMPL_DECLARE(MenuActionSkyNodeSetDateTime)
ACTION_HANDLER_IMPL_DECLARE(MenuActionSkyNodeSetSunVisible)
ACTION_HANDLER_IMPL_DECLARE(MenuActionSkyNodeSetStarsVisible)
ACTION_HANDLER_IMPL_DECLARE(MenuActionSkyNodeSetMoonVisible)
