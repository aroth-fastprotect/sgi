...
#define LOKI_TYPELIST(...) \
    _LOKI_TYPELIST_( _SGI_PP_VARIADIC_SIZE(__VA_ARGS__), __VA_ARGS__ )
#define _LOKI_TYPELIST_( num, ... ) \
    _LOKI_TYPELIST__( num, __VA_ARGS__)
#define _LOKI_TYPELIST__( num, ... ) \
    _SGI_PP_CAT(LOKI_TYPELIST_,num)(__VA_ARGS__)
