...
class actionHandlerImplBaseT : public functionImplBase
{
public:
    struct TypePolicy {
        struct CallParamType
    ...
    actionHandlerImplBaseT(SGIPluginHostInterface * hostInterface=NULL, SGIItemBase * item=NULL, IContextMenuAction * menuAction=NULL)
        : functionImplBase(hostInterface, item)
    ...
    IContextMenuInfo * menuInfo()
    {
        IContextMenu * m = _menuAction->menu();
        return (m != NULL)?m->getInfo():NULL;
    }
    void triggerRepaint()
    {
        IContextMenuInfo * mi = menuInfo();
        if(mi)
            mi->triggerRepaint();
    }
    ...
    {
        return (ACTION_ID_TYPE)_menuAction->actionId();
    }
...
#define ACTION_HANDLER_IMPL_TEMPLATE() \
    ...
    public: \
        typedef sgi::details::constexpr_false accept; \
        actionHandlerImpl(SGIPluginHostInterface * hostInterface=NULL, SGIItemBase * item=NULL, IContextMenuAction * menuAction=NULL) {}\
...
#define ACTION_HANDLER_IMPL_DECLARE(__id) \
    ...
    public: \
        typedef sgi::details::constexpr_true accept; \
        actionHandlerImpl<__id>(SGIPluginHostInterface * hostInterface=NULL, SGIItemBase * item=NULL, IContextMenuAction * menuAction=NULL) \
...
template<template<unsigned> class ImplT>
class settingsDialogCreateImplBaseT : public functionImplBase
{
public:
    struct TypePolicy {
        struct CallParamType
    ...
    settingsDialogCreateImplBaseT(SGIPluginHostInterface * hostInterface=NULL, SGIItemBase * item=NULL, ISettingsDialogInfo * info=NULL)
        : functionImplBase(hostInterface, item)
        , _info(info)
        {
        }
...
#define SETTINGS_DIALOG_CREATE_IMPL_TEMPLATE() \
    ...
    public: \
        typedef sgi::details::constexpr_false accept; \
        settingsDialogCreateImpl(SGIPluginHostInterface * hostInterface=NULL, SGIItemBase * item=NULL, ISettingsDialogInfo * info=NULL) {} \
...
#define SETTINGS_DIALOG_CREATE_IMPL_DECLARE(__id) \
    ...
    public: \
        typedef sgi::details::constexpr_true accept; \
        settingsDialogCreateImpl<__id>(SGIPluginHostInterface * hostInterface=NULL, SGIItemBase * item=NULL, ISettingsDialogInfo * info=NULL) \
