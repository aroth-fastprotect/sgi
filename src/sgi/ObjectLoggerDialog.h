...
public:
                        ObjectLoggerDialog(SGIItemBase * item, IHostCallback * callback=nullptr, QWidget *parent = 0, Qt::WindowFlags f = Qt::WindowFlags());
                        ObjectLoggerDialog(IObjectLogger * logger, IHostCallback * callback=nullptr, QWidget *parent = 0, Qt::WindowFlags f = Qt::WindowFlags());
