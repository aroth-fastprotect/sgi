...
public:
    ...
    void moveGLContextToThread(QThread * targetThread);
...
class GraphicsThreadQt5 : public osg::GraphicsThread
{
public:
    GraphicsThreadQt5(GraphicsWindowQt5 * gw);
...
public:
  ...
  //  virtual void setTouchEventsEnabled( bool e ) { _widget->setTouchEventsEnabled(e); }
    ...
    void createGraphicsThread() override;
