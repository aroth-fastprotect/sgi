...
# here we use the command to generate the library
    ...
    ADD_LIBRARY(${TARGET_TARGETNAME} MODULE ${TARGET_SRC} ${TARGET_H} ${TARGET_MOC_H} ${TARGET_GLSL} ${TARGET_IN})
...
# here we use the command to generate the library
    ...
    ADD_LIBRARY(${TARGET_TARGETNAME} SHARED ${TARGET_SRC} ${TARGET_H} ${TARGET_MOC_H} ${TARGET_GLSL} ${TARGET_IN})
...
MACRO(SETUP_EXE IS_COMMANDLINE_APP)
    ...
    IF(${IS_COMMANDLINE_APP})
        ...
        ADD_EXECUTABLE(${TARGET_TARGETNAME} ${TARGET_SRC} ${TARGET_H} ${TARGET_MOC_H})
    ...
    ELSE(${IS_COMMANDLINE_APP})
        ...
        ADD_EXECUTABLE(${TARGET_TARGETNAME} ${PLATFORM_SPECIFIC_CONTROL} ${TARGET_SRC} ${TARGET_H} ${TARGET_MOC_H})
