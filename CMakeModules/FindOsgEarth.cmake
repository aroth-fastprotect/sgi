...
if(EXISTS ${OSGEARTH_INCLUDE_DIR}/osgEarth/Version)
    ...
    IF(_osgearth_version_header_contents)
        ...
        string (REGEX MATCH "OSGEARTH_SOVERSION[ \t]+([0-9]+)" _temp_OSGEARTH_SOVERSION ${_osgearth_version_header_contents})
        if(_temp_OSGEARTH_SOVERSION)
            string (REGEX MATCH "([0-9]+)" OSGEARTH_SOVERSION ${_temp_OSGEARTH_SOVERSION})
        else()
